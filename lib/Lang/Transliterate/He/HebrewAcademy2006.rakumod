...
unit class Lang::Transliterate::He::HebrewAcademy2006 does Lang::Transliterate::Transliterator;

# Hebrew Academy Transliteration 2006 for Hebrew
# Based on the Wikipedia comparison table
my %base-mappings = (
    # Hebrew to Latin - Hebrew Academy 2006 system
    # Consonants
    ...
    "\c[0x05E5]" => 'ts',     # ץ tsadi sofit
    "\c[0x05E6]" => 'ts',     # צ tsadi
    "\c[0x05E6]\c[0x05BC]" => 'ts', # צּ tsadi with dagesh
    "\c[0x05E5]\c[0x05F3]" => 'č',  # ץ׳ tshadi sofit (loanword)
    "\c[0x05E6]\c[0x05F3]" => 'č',  # צ׳ tshadi (loanword)
    "\c[0x05E7]" => 'k',      # ק kuf
    ...
    "\c[0x05EA]\c[0x05F3]" => 'ṯ',  # ת׳ thav (foreign)
    ...
    "\c[0x05D5]\c[0x05BC]\c[0x05BC]" => 'vv',  # וּּ vav hazak
    ...
    "\c[0x05E6]\c[0x05BC]\c[0x05BC]" => 'tssts', # צּּ tsadi hazak (or ẕẕ)
    "\c[0x05E7]\c[0x05BC]\c[0x05BC]" => 'kk',  # קּּ kuf hazak
    "\c[0x05E8]\c[0x05BC]\c[0x05BC]" => 'rr',  # רּּ resh hazak
    "\c[0x05EA]\c[0x05BC]\c[0x05BC]" => 'tt',  # תּּ tav hazak
);
...
method get-reverse-mappings(--> List) {
    # Hebrew Academy 2006 reverse mappings
    return (
        ...
        'tssts' => "\c[0x05E6]\c[0x05BC]\c[0x05BC]", # צּּ
...
# Hebrew Academy 2006 omits alef at word initial and he at word final
