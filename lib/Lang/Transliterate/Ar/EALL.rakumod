...
unit class Lang::Transliterate::Ar::EALL does Lang::Transliterate::Transliterator;

# Arabic EALL Transliteration
# Based on the Encyclopedia of Arabic Language and Linguistics (EALL) transliteration standard
# Distinctive features: uses x for خ, ġ for غ, ẓ for ظ in proper names
...
my %base-mappings = (
    ...
    "\c[0x0636]" => 'ḍ',      # dad (ض)
    "\c[0x0637]" => 'ṭ',      # ta (ط)
    "\c[0x0638]" => 'ẓ',      # za (ظ) - EALL suggests ẓ "in proper names"
    "\c[0x0639]" => 'ʿ',      # ayn (ع) - left half ring
    "\c[0x063A]" => 'ġ',      # ghayn (غ) - EALL uses ġ
    "\c[0x0641]" => 'f',      # fa (ف)
    "\c[0x0642]" => 'q',      # qaf (ق)
    "\c[0x0643]" => 'k',      # kaf (ك)
    "\c[0x0644]" => 'l',      # lam (ل)
    ...
    # Special forms
    "\c[0x0622]" => 'ʾā',     # alif madda (آ) - EALL uses ʾā
    "\c[0x0629]" => 'h',      # ta marbuta (ة) - h in pausa, t in construct
    "\c[0x0649]" => 'ā',      # alif maqsura (ى) - EALL uses ā
    
    # Definite article (EALL uses lowercase a and hyphen)
...
method get-reverse-mappings(--> List) {
    ...
    return (
        ...
        'ṯ' => "\c[0x062B]",
        'ḥ' => "\c[0x062D]",
        'x' => "\c[0x062E]",      # EALL distinctive feature
        'ḏ' => "\c[0x0630]",
        'š' => "\c[0x0634]",
        'ṣ' => "\c[0x0635]",
        'ḍ' => "\c[0x0636]",
        ...
        'ẓ' => "\c[0x0638]",
        'ʿ' => "\c[0x0639]",
        'ġ' => "\c[0x063A]",     # EALL distinctive feature
        'ʾ' => "\c[0x0621]",
        'ī' => "\c[0x0650]\c[0x064A]",
        'ū' => "\c[0x064F]\c[0x0648]",
