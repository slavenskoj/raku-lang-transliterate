...
unit class Lang::Transliterate::Be::National2000 does Lang::Transliterate::Transliterator;

# Belarusian National 2000 Transliteration
# Instruction on transliteration of Belarusian geographical names
# For е, ё, ю, я, the digraphs je, jo, ju, ja are used word-initially,
# and after a vowel, apostrophe ('), separating ь, or ў
my %base-mappings = (
    # Belarusian Cyrillic to Latin National 2000
    'а' => 'a',
    'б' => 'b',
    'в' => 'v',
    'г' => 'h',
...
method get-reverse-mappings(--> List) {
    # National 2000 reverse mappings
    return (
        # Contextual forms
        'je' => 'е',
        'jo' => 'ё', 
